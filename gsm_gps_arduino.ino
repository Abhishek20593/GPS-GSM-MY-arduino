...
void init_sms()
{
  ...
  delay(400);
  Serial.println("AT+CMGS=\"+9100000000\"");   //  Write Your Phone No.
  delay(400);
}
...
{
    init_sms();
    send_data("Current Location Alert:");
    send_data("Your Current Location is:");
    Serial.print("Latitude:");
    send_data(latitude);
    Serial.print("Longitude:");
    send_data(longitude);
    send_data("See Current Location Latitude and Longitude found from Google..\nThankyou");
    send_sms();
    delay(2000);
    lcd_status();
}
